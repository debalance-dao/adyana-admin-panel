            ...
            <div
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg px-6 lg:min-h-[758px] py-20">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <form class="space-y-5" @submit.prevent="window.location='/'">
                            ...
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input type="checkbox" class="form-checkbox bg-white" />
                        ...
                        <div class="text-center"> Already have an account ? <a href="/auth/boxed-signin" class="uppercase text-primary underline transition hover:text-black">SIGN IN</a>
                        </div>
                    </div>
                </div>
            </div>
