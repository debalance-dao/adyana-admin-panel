        ...
        document.addEventListener("alpine:init", () => {
            Alpine.data("form", () => ({
                form4: {
                    ...
                    funds_target: '{{ $project->funds_target }}',
                    days_target: '{{ $project->days_target }}',
                    image_file: '',
                },
                validated: {
                    name: '',
                ...
                sendFormData() {
                    ...
                    formData.append('description', this.form4.description.replace(/^"(.*)"$/, '$1'));
                    formData.append('funds_target', this.form4.funds_target);
                    formData.append('days_target', this.form4.days_target);

                    if (file.cachedFileArray.length > 0) {
                        formData.append('image_file', file.cachedFileArray[0]);
                    }
